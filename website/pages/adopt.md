...
<tr><td><code>pre-commit</code> hook</td><td>Runs <code>roteiro check</code> and <strong>blocks a commit that introduces drift</strong> (a dangling ADR link, a stale <code>@rto:</code> annotation, or an <code>#[allow(…)]</code> that says why it is there in neither a <code>reason = "…"</code> field nor a comment). Skip once with <code>git commit --no-verify</code>.</td></tr>
