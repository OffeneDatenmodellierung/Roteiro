...
[[crates/rto-render/src/okf/read.rs#read_bundle]], which screens its body, title
and description separately. So excluding prose here removes no protection from
anything external.
