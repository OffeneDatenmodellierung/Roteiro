...
## [5.11.1](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-serve-v5.11.0...rto-serve-v5.11.1) - 2026-09-11
...
## [5.9.0](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-serve-v5.8.1...rto-serve-v5.9.0) - 2026-09-08
...
- *(serve)* say why the new router's allow is allowed
...
- *(serve)* decline a `required` this renderer cannot read, and sort arguments

### Other

- Merge pull request #594 from OffeneDatenmodellierung/feat/mcp-surface-bundle
- *(serve)* advertise tools as signatures, not raw JSON Schema
...
- *(serve)* price the three request-context constants as one budget

### Other

- Merge branch 'main' into fix/556-request-budget
