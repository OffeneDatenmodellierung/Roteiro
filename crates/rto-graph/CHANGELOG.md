...
## [5.11.1](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-graph-v5.11.0...rto-graph-v5.11.1) - 2026-09-11
...
## [5.8.0](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-graph-v5.7.0...rto-graph-v5.8.0) - 2026-09-07

### Added

- *(graph)* screen text decoded out of a binary before it becomes content

### Fixed

- *(graph)* bump EXTRACT_BASE_VERSION — a cached PDF kept its unscreened text

### Other

- *(graph)* use Screened::is_clean rather than reaching into findings

## [5.4.0](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-graph-v5.3.0...rto-graph-v5.4.0) - 2026-09-02
...
- *(deps)* bump ocrs and rten together, and group them so they stay that way
- *(graph)* document Provenance's 3-to-6 variant change for consumers
...
- *(score)* refuse a run that judges one commit twice
...
- *(deps)* drop the yanked `bisync` by moving to gix 0.87
...
- *(sync)* say what the overlay actually carries, and pin the ignore boundary
...
## [2.3.0](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-graph-v2.2.0...rto-graph-v2.3.0) - 2026-08-22

### Added

- *(links)* persist authored [[links]], making the `authored → gold` path reachable

## [2.1.0](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-graph-v2.0.2...rto-graph-v2.1.0) - 2026-08-22
...
## [2.0.2](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-graph-v2.0.1...rto-graph-v2.0.2) - 2026-08-21

### Fixed

- *(serve,spec)* strip `<think>` on `/v1`, and refuse an unterminated block

## [1.30.0](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-graph-v1.29.0...rto-graph-v1.30.0) - 2026-08-21

### Other

- Merge pull request #566 from OffeneDatenmodellierung/ci/pin-stable-toolchain
- *(media)* name which decoders use `as_chunks`, and why the guard is vacuous at 8-bit

## [1.29.0](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-graph-v1.28.0...rto-graph-v1.29.0) - 2026-08-20
...
- *(review)* score a candidate reviewer against the adjudicated corpus
...
- *(extract)* bump EXTRACT_VERSION 11 → 12 for the marker-needle fix
