...
## [0.0.20](https://github.com/OffeneDatenmodellierung/Roteiro/compare/rto-graph-v0.0.19...rto-graph-v0.0.20) - 2026-08-11

### Added

- *(serve)* live workspace reload on SIGHUP (ADR-0008)
- *(store)* busy_timeout so workspace serve tolerates concurrent syncs
